...
#' 
#' @keywords internal
setMethod("extractObs", signature = signature("multiFunData", "ANY", "ANY"), 
          function(object, obs, xVal){multiFunData(mapply(extractObs, object = object, xVal = xVal, obs = obs))
          })
